const NButton = {
  baseClass: "border rounded items-center justify-center focus:outline-none",
  loadingClass: "animation-rotate-360",
  iconClass: "icon iconfont not-italic",
  defaultClass:
  ...
  tertiaryClass:
    "border underline text-blue-500 border-transparent bg-transparent hover:text-blue-600",
  successClass:
  ...
  defaultSizeClass: "px-6 py-3 text-sm",
  xsSizeClass: "px-3 py-2 text-xs",
  smSizeClass: "px-3 py-2 text-sm",
  baseSizeClass: "px-4 py-2 text-base",
  lgSizeClass: "px-4 py-2 text-lg",
  xlSizeClass: "px-5 py-2 text-xl"
};
