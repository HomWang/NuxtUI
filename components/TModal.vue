  ...
  <transition :name="transition">
    ...
    >
      <div ref="container" :style="containerStyle" :class="containerClass">
        <div :style="{ minHeight: normalizedHeight }" :class="wrapperClass">
          <button
      ...
      <div :class="overlayClass" @click="outsideClick" />
    </div>
  </transition>
</template>
...
import TModalTheme from "../plugins/themes/default/TModal";
...
export default {
  ...
  methods: {
    calculateMarginTop() {
      ...
      const marginTop =
        (viewportHeight - modalHeight + adjustement) * this.pivotY;
