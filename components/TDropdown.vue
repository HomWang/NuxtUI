<template>
  ...
  >
    <div ref="dropdown" :class="dropdownClass" @click="dropdownClick">
      <slot />
    </div>
    ...
    >
      <slot :shown="shown" name="button-content">
        {{ text }}
      </slot>
      <svg
        v-if="visibleArrow"
...
import TDropdownTheme from "../plugins/themes/default/TDropdown";

const { baseClass, dropdownClass, disabledClass } = TDropdownTheme;
