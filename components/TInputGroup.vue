...
import TInputGroupTheme from "../plugins/themes/default/TInputGroup";
...
export default {
  ...
  computed: {
     ...
     */
    elementsToRender() {
      return this.orderedElements.filter(
        e => e === "default" || !!this.$props[e] || !!this.$slots[e]
      );
    },
  ...
  methods: {
    ...
    getTagClasses(statusName, slotName) {
      ...
      return [
        this[`${slotClassName}Class`],
        this.statusClass[statusName][slotClassName]
      ];
    }
  }
};
