  ...
  <component :is="tagName" :class="currentClass">
    ...
    >
      <button
        :class="[
          buttonClass,
          prevIsDisabled ? disabledControlButtonClass : controlButtonClass
        ]"
    ...
    >
      <button
        :class="[
          buttonClass,
          nextIsDisabled ? disabledControlButtonClass : controlButtonClass
        ]"
...
import TPaginationTheme from "../plugins/themes/default/TPagination";
