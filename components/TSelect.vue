<template>
  <div ref="select-wrapper" :class="wrapperClass">
    <select
      :id="id"
      ref="select"
    ...
    <div v-if="!multiple" :class="arrowWrapperClass">
      <svg
        :class="arrowClass"
...
import TSelectTheme from "../plugins/themes/default/TSelect";
...
export default {
  ...
  // mixins: [commonAttributes, handleClasses, hasMultioptions],s
      ...
      if (option.children && Array.isArray(option.children)) {
        return {
          ...
          children: option.children.map(childOption =>
            this.normalizeOption(childOption)
          )
        };
      }
