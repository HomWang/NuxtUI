<template>
  <component :is="tagName" v-if="localShow" :class="currentClass">
    <slot />
    <span
      v-if="dismissible"
      ref="close"
...
import TAlertTheme from "../plugins/themes/default/TAlert";
  ...
  props: {
    ...
    variant: {
      ...
      validator: function(value) {
        return (
          value === null ||
          ["danger", "warning", "success", "info"].indexOf(value) !== -1
        );
      }
    },
    dismissible: {
